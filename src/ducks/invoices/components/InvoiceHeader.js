...
const InvoiceHeader = () => {
    ...
    return (
        <div className="mb-1">
            {confirmDuplicate && (
                <DuplicateCartAlert SalesOrderNo={invoice.SalesOrderNo ?? ''} newCartName={newCartName}
                                    loading={cartLoading}
                                    onSetCartName={(value) => setNewCartName(value)}
                ...
                <div className="col-md-6">
                    ...
                    {!!invoice.UDF_PROMO_DEAL && (
                        <FormGroup colWidth={8} label="Promo Code">
                            <OrderPromoCode code={invoice.UDF_PROMO_DEAL} disabled={true} closed={true}/>
                        </FormGroup>
                    )}
