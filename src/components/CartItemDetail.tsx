...
import {CartItemDetailProps} from "../_types";
import Decimal from "decimal.js";
import {CartProduct, CustomerPriceRecord} from "b2b-types";
import {selectProductCustomerPrice} from "../ducks/products/selectors";
    ...
    return (
        <>
            ...
            {new Decimal(cartItem.quantity ?? 1).gt(availableToday) && (
                <Alert type="warning" title="Note: ">Product is not available for immediate delivery.</Alert>
            )}
        </>
    )
}
