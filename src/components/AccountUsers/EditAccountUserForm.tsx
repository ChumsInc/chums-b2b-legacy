...
import {ExtendedCustomerUser} from "./types";
...
const EditAccountUserForm = ({
                                 ...
                                 onNewUser,
                                 onDeleteUser
                             }: EditAccountUserFormProps) => {
    const changeHandler = (field: keyof ExtendedCustomerUser) => (ev: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
