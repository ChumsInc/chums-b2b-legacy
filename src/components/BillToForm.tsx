...
import {BillToCustomer} from "b2b-types/src/customer";
...
const BillToForm = () => {
    ...
    const [account, setAccount] = useState<BillToCustomer & Editable | null>(current as BillToCustomer ?? null);
    ...
    const changeHandler = ({field, value}: TextInputChangeHandler<BillToCustomer>) => {
        if (account && field) {
