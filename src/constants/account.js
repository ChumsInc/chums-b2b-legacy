...
export const filteredTermsCode = (code) => {
    return TERMS_CODES[code] || {};
};

export const TERMS_CODES = {
...
export const    PAYMENT_TYPES = {
    ...
    //     message: 'Credit Card checkout is not available.',
    //     allowTerms: false,
    //     disabled: true,
    //     requirePO: false,
    //     prepaid: true,
    ...
    //     sageCode: 'PAYPA',
    //     description: 'Pay Pal',
    //     message: 'Pay Pal checkout is not available.',
    //     allowTerms: false,
    //     disabled: true,
    //     requirePO: false,
    //     prepaid: true,
...
export const getShippingMethod = (code) => {
    return SHIPPING_METHODS[code] || {};
};
