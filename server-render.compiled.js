...
var pageRegexp = (0, _pathToRegexp.pathToRegexp)('/pages/:page');
...
function _handleRender() {
  _handleRender = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var status, result, defaultState, initialState, state, keywords, parsedProduct, keyword, search, _keywords$filter, _keywords$filter2, found, _keywords$filter3, _keywords$filter4, _yield$loadJSON, products, product, _products, prod, variant, msrp, salesUM, cartItem, _yield$loadJSON2, categories, _categories, _categories$, category, _category$id, id, _category$title, title, _category$pageText, pageText, _category$lifestyle, lifestyle, _category$children, children, _pageRegexp$exec, _initialState, parsedPage, _initialState$page$li, _initialState$page$li2, _keyword, _res$page, _res, store, html, helmet, preloadedState, _yield$fs$promises$st, swatchMTime, _yield$fs$promises$st2, cssMTime, manifestFiles, css, manifest, site;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 71:
          ...
          break;
        case 73:
          if (!pageRegexp.test(req.path)) {
            _context7.next = 81;
            break;
          }
          parsedPage = (_pageRegexp$exec = pageRegexp.exec(req.path)) !== null && _pageRegexp$exec !== void 0 ? _pageRegexp$exec : [];
          _initialState$page$li = (_initialState = initialState) === null || _initialState === void 0 || (_initialState = _initialState.page) === null || _initialState === void 0 || (_initialState = _initialState.list) === null || _initialState === void 0 ? void 0 : _initialState.filter(function (kw) {
            return kw.keyword === parsedPage[1];
          }), _initialState$page$li2 = _slicedToArray(_initialState$page$li, 1), _keyword = _initialState$page$li2[0];
          if (!_keyword) {
            _context7.next = 81;
            break;
          }
          _context7.next = 79;
          return loadJSON("http://localhost:".concat(API_PORT, "/pages/").concat(encodeURIComponent(_keyword.keyword), ".json"));
        case 79:
          _res = _context7.sent;
          initialState.page.content = (_res$page = _res.page) !== null && _res$page !== void 0 ? _res$page : {};
        case 81:
          _context7.prev = 81;
        ...
        case 105:
          _context7.prev = 105;
          _context7.t3 = _context7["catch"](81);
    ...
    }, _callee7, null, [[3, 13], [30, 37], [46, 68], [81, 105]]);
  }));
  return _handleRender.apply(this, arguments);
}
